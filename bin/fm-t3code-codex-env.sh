...
# owned by spawn_t3code_env_install in fm-spawn.sh.
set -eu
...
try:
    ...
    refuse("Python 3.11+ with tomllib is required to validate tracked configuration")
try:
