...
On the t3code backend T3 owns the system prompt, so the same statement is written as a git-excluded `CLAUDE.local.md` in the worker's worktree instead ([`docs/t3code-backend.md`](../../../../../docs/t3code-backend.md)).
